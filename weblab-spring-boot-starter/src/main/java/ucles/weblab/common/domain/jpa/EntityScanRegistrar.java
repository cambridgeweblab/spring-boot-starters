/*
 * Copied from deprecated implementation in Spring Boot 1.4
 *
...
/**
 * {@link ImportBeanDefinitionRegistrar} brought over from Boot 1.4 but to work with modern {@link EntityScan}.
 *
 * To use, do <code>@Import(EntityScanRegistrar.class)</code>
 *
 * @author Phillip Webb
